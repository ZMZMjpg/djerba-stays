...
import { setPropertyStatus, deleteProperty } from "@/lib/admin-properties";
    ...
    <div>
      <div className="flex items-center justify-between">
        ...
        <Link
          ...
          className="flex items-center gap-2 rounded-md bg-djerba px-4 py-2.5 text-sm font-medium text-cream hover:bg-djerba-dark"
        >
          <Plus size={16} />
          Add house
        </Link>
                  ...
                  <td className="px-5 py-3">
                    <div className="flex items-center gap-3">
                      <Link
                        ...
                        className="text-djerba hover:underline"
                      >
                        Edit
                      </Link>
                      <button
