      ...
      <main className="pt-32 pb-24">
        <section className="container-page max-w-xl">
          ...
          <p className="mt-4 text-base text-ink/70">
            ...
            specific? Reach out directly and we&apos;ll get back to you.
          </p>
          ...
          <div className="mt-8 space-y-4">
              ...
              className="flex items-center gap-3 rounded-md border border-djerba/15 px-5 py-4 text-sm font-medium text-ink hover:bg-sand"
            >
              <MessageCircle size={18} className="text-djerba" />
              Message us on WhatsApp
            </a>
            
              href="mailto:hello@djerbastays.com"
              className="flex items-center gap-3 rounded-md border border-djerba/15 px-5 py-4 text-sm font-medium text-ink hover:bg-sand"
            >
