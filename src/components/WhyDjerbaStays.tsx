...
const reasons = [
  {
    ...
    description:
      "Every property is known to us personally — not scraped from another platform.",
  },
  {
    icon: KeyRound,
    title: "Real local knowledge",
    description:
      "We know Djerba. We'll point you to the right area for what you're after.",
  },
  {
    icon: MessageCircleHeart,
    title: "A human on the other end",
    description:
      "Send an inquiry and talk to someone who actually knows the house.",
  },
];
    ...
    <section className="bg-sand/60 py-24">
      <div className="container-page">
        ...
        <h2 className="mt-2 max-w-xl text-display-sm text-ink">
          A local team, not a booking algorithm.
        </h2>
